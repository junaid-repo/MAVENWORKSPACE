...
public class URIConstants {
	...
	public static final String CREATE_UPLOAD_TABLE_FROM_URI = "webService/createAndUploadTablesAndData";
	...
	public static final String UPLOAD_TABLE_WITH_DATA = "webService/uploadDataTable";
