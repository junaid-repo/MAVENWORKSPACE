...
insert into Course (id, name, created_date, last_updated_date) 
values(1003, 'JavaScript', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
...
insert into Passport(id, passportnumber) values(3002, 'FV12359GX');
insert into Passport(id, passportnumber) values(3003, 'JH98323NB');
insert into Passport(id, passportnumber) values(3004, 'VB41230SN');
