...
public class HibdemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		reviews.add(new Review("4", "Awesome, but can be better"));
		reviews.add(new Review("3", "Average, had experienced better"));

		repo.addReviewsForCourses(1004L, reviews);
		repo.addHardCodedReviewsForCourses();
		srepo.insertStudentAndCourse();
